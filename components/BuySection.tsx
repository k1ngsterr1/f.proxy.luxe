...
export const BuySection: FC = () => {
    const [reference, setReference] = useState<Omit<ResponseReference, "status"> | null>(null);
    ...
    const fetchReference = useCallback(async () => {
        if (!reference) {
            ...
            setReference(!isBoolean(result) ? result : null)
        }
    }, [])
        ...
        return (
            <div className="buy-inner">
                <ProxyBuyCard
                    ...
                    <IspBuyForm amounts={reference.amounts}
                ...
                <ProxyBuyCard
                    ...
                    <IpV6BuyForm amounts={reference.amounts.filter((value, index) => index !== 0)}
