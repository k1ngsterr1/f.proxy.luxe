          ...
          <div className="buy-inner">
            <div className="buy-col">
              ...
              >
                ...
                <p className="buy-item__about">
                  Подходят для всех сайтов. Кроме платёжных систем. Выдаются в
                  одни руки
                </p>
                ...
                <select className="buy-item__select">
                  <option value="1">Напишите свою почту</option>
                  <option value="2">Напишите свою почту</option>
                </select> */}
            ...
            <div className="buy-col">
              ...
              >
                ...
                >
                  <option value="1">HTTPs / SOCKS5</option>
                  <option value="2">HTTPs / SOCKS5</option>
                </select>
                <h4
                  className="buy-item__subheader"
                  style={{
        ...
        <div className="container">
          ...
          <div className="advantages-inner">
            <div className="adv-item">
              ...
              <p className="adv-item__text">
                У нас одни из самых низких цен на рынке.
              </p>
            </div>
            <div className="adv-item">
              <div className="adv-item__img">
              ...
              <div className="adv-item__line"></div>
              <p className="adv-item__text">
                Прокси активируются сразу же после оплаты.
              </p>
            </div>
            <div className="adv-item">
              <div className="adv-item__img">
              ...
              <div className="adv-item__line"></div>
              <p className="adv-item__text">
                Продажа прокси ведется исключительно в одни руки.
              </p>
            </div>
            <div className="adv-item">
              <div className="adv-item__img">
              ...
              <div className="adv-item__line"></div>
              <p className="adv-item__text">
                Прокси переключаются с HTTPS на SOCKS5 и обратно в личном
                кабинете.
              </p>
            </div>
            <div className="adv-item">
              ...
              <div className="adv-item__line"></div>
              <p className="adv-item__text">
                Вы можете купить хоть один прокси, кол-во не имеет значения.
              </p>
            </div>
            <div className="adv-item">
              <div className="adv-item__img">
              ...
              <div className="adv-item__line"></div>
              <p className="adv-item__text">
                Возможность покупки прокси на 3 дня, 1 неделю, 2 недели, либо 1
                месяц.
              </p>
            </div>
            <div className="adv-item">
              ...
              <div className="adv-item__line"></div>
              <p className="adv-item__text">
                Api позволит вам интегрировать покупку и продление прокси в ваш
                сервис.
              </p>
            </div>
            <div className="adv-item">
              ...
              <div className="adv-item__line"></div>
              <p className="adv-item__text">
                Мы стараемся отвечать на все ваши вопросы как можно быстрее.
              </p>
            </div>
          </div>
